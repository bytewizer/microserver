    ...
    public class HttpServer
    {
        ...
        private void Response(Socket socket)
        {
            using (var network = new NetworkStream(socket))
            {
                ...
                {
                    // This works on both versions but will only read the first line of the headers
                    var line = reader.ReadLine();
                    Debug.WriteLine(line);

                    // This works on preview 3 only and hangs at "ReadLine()" on preview 4              
                    //string line;
                    ...
                    // This works on preview 3 only and hangs at "Peek()" on preview 4  
                    //while (reader.Peek() != -1)
                    //{
                    //    var line = reader.ReadLine();
                    //    Debug.WriteLine(line);
