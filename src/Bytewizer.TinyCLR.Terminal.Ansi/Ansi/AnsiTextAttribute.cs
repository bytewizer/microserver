namespace Bytewizer.TinyCLR.Terminal.Ansi
{
    ...
    /// Dim (2) and Blink (5) are intentionally omitted as support is not universal and might not be recommended to use even if they were.
    /// </remarks>
    public enum AnsiTextAttribute : int
    {
        /// <summary>
        /// Normal attribute. Resets all other active attributes.
        /// </summary>
        Normal = 0,
