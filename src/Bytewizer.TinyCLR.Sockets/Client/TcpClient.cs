...
namespace Bytewizer.TinyCLR.Sockets.Client
{
    /// <summary>
    ...
    public class TcpClient : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TcpClient"/> class and binds it to the specified local endpoint.
        /// </summary>
        ...
        /// <summary>
        /// Disposes this <see cref="TcpClient"/> instance and requests that the underlying TCP connection be closed.
        /// </summary>
        public void Close()
        {
            Dispose();
        ...
        /// <summary>
        /// Frees resources used by the <see cref="TcpClient"/> class.
        /// </summary>
        ~TcpClient()
        {
            {
        ...
        /// <summary>
        /// Releases the managed and unmanaged resources used by the <see cref="TcpClient"/>.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
