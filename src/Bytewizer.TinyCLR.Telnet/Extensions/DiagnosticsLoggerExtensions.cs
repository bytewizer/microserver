...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static class DiagnosticsLoggerExtensions
    {
        ...
        public static void CommandExecuted(this ILogger logger, TelnetContext context, RouteEndpoint endpoint)
        {
            logger.Log(
                LogLevel.Trace,
                _commandRequest,
        ...
        public static void EndpointRoutes(this ILogger logger, CommandEndpointProvider provider)
        {
