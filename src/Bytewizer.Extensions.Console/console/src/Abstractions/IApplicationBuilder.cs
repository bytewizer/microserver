...
namespace Bytewizer.Extensions.Console
{
    ...
    public interface IApplicationBuilder
    {
        ...
        /// <summary>
        /// Set up the configuration for the builder itself. This will be used to initialize the <see cref="IApplicationEnvironment"/>
        ...
        /// <returns>The same instance of the <see cref="IApplicationBuilder"/> for chaining.</returns>
        IApplicationBuilder ConfigureAppConfiguration(Action<ApplicationBuilderContext, IConfigurationBuilder> configureDelegate);
        ...
        /// <returns>The same instance of the <see cref="IApplicationBuilder"/> for chaining.</returns>
        IApplicationBuilder ConfigureServices(Action<ApplicationBuilderContext, IServiceCollection> configureDelegate);
        ...
        /// <typeparam name="TContainerBuilder">The type of builder.</typeparam>
        /// <returns>The same instance of the <see cref="IApplicationBuilder"/> for chaining.</returns>
        IApplicationBuilder UseServiceProviderFactory<TContainerBuilder>(Func<ApplicationBuilderContext, IServiceProviderFactory<TContainerBuilder>> factory);
        ...
        /// <returns>The same instance of the <see cref="IApplicationBuilder"/> for chaining.</returns>
        IApplicationBuilder ConfigureContainer<TContainerBuilder>(Action<ApplicationBuilderContext, TContainerBuilder> configureDelegate);
