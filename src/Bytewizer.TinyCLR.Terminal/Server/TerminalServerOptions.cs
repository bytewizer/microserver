...
{
    /// <summary>
    /// Represents an implementation of the <see cref="TerminalServerOptions"/> for creating terminal servers.
    /// </summary>
    public class TerminalServerOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TerminalServerOptions"/> class.
        /// </summary>
        public TerminalServerOptions()
        {
