...
{
    /// <summary>
    /// Represents an implementation of the <see cref="TelnetServer"/> for creating terminal servers.
    /// </summary>
    public class TelnetServer : SocketService, IServerService
    {
            ...
            : base(loggerFactory)
        {
            ...
            _terminalOptions = _options as TelnetServerOptions;
        ...
        private void Initialize(ServerOptionsDelegate configure)
        {
            ...
            {
                app.Use(new TelnetMiddleware(_logger, _terminalOptions));
            });
