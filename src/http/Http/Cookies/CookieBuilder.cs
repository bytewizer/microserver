...
namespace Bytewizer.TinyCLR.Http
{
    ...
    public class CookieBuilder
    {
        ...
        public CookieOptions Build(HttpContext context) => Build(context, DateTime.Now);
        ...
        /// <returns>The cookie options.</returns>
        public virtual CookieOptions Build(HttpContext context, DateTime expiresFrom)
        {       
            if (context == null)
            {
            ...
            return new CookieOptions
            {
                ...
                Secure = SecurePolicy == CookieSecurePolicy.Always || (SecurePolicy == CookieSecurePolicy.SameAsRequest),
                //TODO: Expires = Expiration.HasValue ? expiresFrom.Add(Expiration.GetValueOrDefault()) : default(DateTimeOffset?)
            };
        }
    }
}
