...
namespace Bytewizer.TinyCLR.Http
{
    ...
    {       
        //TODO: Trim way down
        private static readonly Hashtable StaticContentTypes = new Hashtable()
        {
            //{ ".323", "text/h323" },
            //{ ".3g2", "video/3gpp2" },
            //{ ".3gp2", "video/3gpp2" },
        ...
        public bool TryGetContentType(string subpath, out string contentType)
        {
            ...
            if (StaticContentTypes.Contains(extension))
            {
                contentType = (string)StaticContentTypes[extension];
                return true;
            }
