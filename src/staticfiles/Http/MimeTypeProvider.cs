...
namespace Bytewizer.TinyCLR.Http
{
    ...
    public class MimeTypeProvider
    {
        ...
        /// Gets singleton
        /// </summary>
        public static MimeTypeProvider Instance { get; } = new MimeTypeProvider();
        ...
        public string Get(string filename)
        {
            ...
            if (_items.Contains(extension.TrimStart('.')))
            {
                return (string)_items[extension.TrimStart('.')];
            }
            else
            {
                return (string)_items["default"];
            }
        }
    }
}